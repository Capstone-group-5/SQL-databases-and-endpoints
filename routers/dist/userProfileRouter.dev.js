...
router.get('/get_all_profiles', function _callee(req, res) {
  var db, profiles;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          db = _context2.sent;
          _context2.next = 6;
          return regeneratorRuntime.awrap(db.all('SELECT * FROM user_profile'));
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        ...
        case 4:
          db = _context6.sent;
          _context6.next = 7;
          return regeneratorRuntime.awrap(db.run('DELETE FROM user_profile WHERE id = ?', [id]));
